...
export default function GlazingPage() {
  return (
    <div className="flex flex-col md:flex-row m-0 justify-between mb-60">
      ...
      <div className="md:w-full h-[100vh] bg-[#000000] shadow-[0_35px_70px_-15px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.25)] relative overflow-hidden flex flex-col justify-end px-10 pb-15">
        ...
        <a
          className="w-20 text-4xl absolute top-[300px] left-[190px] h-20 flex items-center justify-center rounded-full bg-black cursor-pointer text-white transition duration-500"
          href="https://x.com/Tofunmi_Ololuo"
        >
        ...
        <div className="flex flex-row justify-between">
          <div className="text-white font-black md:text-[13rem] text-[6.4rem] leading-[0.72] tracking-[-12px] -rotate-[0deg] origin-bottom-left select-none z-10">
            Tofunmi
            <br />
            Ololuo
          </div>
          <div className="flex flex-row space-x-2 mt-36">
            <div className="w-20 h-20 flex items-center justify-center rounded-full hover:bg-white border-[0.5px] cursor-pointer text-white hover:text-black transition duration-500">
              <FontAwesomeIcon icon={faFigma} className="w-6 h-6" />
            </div>
            <div className="w-20 h-20 flex items-center justify-center rounded-full bg-black hover:bg-white border-[0.5px] cursor-pointer hover:text-black text-white transition duration-500">
              <FontAwesomeIcon icon={faDribbble} className="w-6 h-6" />
